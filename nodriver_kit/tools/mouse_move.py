...
CLI:
    python -m nodriver_kit.tools.mouse_move --x 100 --y 200

Python:
    from nodriver_kit.tools import mouse_move
    result = await mouse_move(tab, x=100, y=200)
"""

from nodriver_kit.core import mouse_move as core_mouse_move
