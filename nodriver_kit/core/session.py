"""Session management for nodriver-kit.

Each nodriver-kit process gets a unique session ID, used to identify
...
The session ID is passed to Chrome as a command line argument:
    --nodriver-kit-session=<session_id>
...
SESSION_FLAG = "--nodriver-kit-session"
